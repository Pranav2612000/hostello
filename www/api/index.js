...
// app/root.tsx
var import_focus_visible = require("focus-visible"), import_jsx_dev_runtime = require("react/jsx-dev-runtime"), loader = (args) => (0, import_ssr.rootAuthLoader)(args), CatchBoundary = (0, import_remix.ClerkCatchBoundary)(), ourTheme = {
  ...theme,
  colors: {
    ...theme.colors,
    hostelloRed: {
...
var import_react9 = require("@chakra-ui/react"), import_remix2 = require("@clerk/remix"), import_jsx_dev_runtime = require("react/jsx-dev-runtime");
function SignInRoute() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react9.Center, {
    height: "100vh",
    p: 10,
...
var import_react10 = require("@chakra-ui/react"), import_remix3 = require("@clerk/remix"), import_jsx_dev_runtime = require("react/jsx-dev-runtime");
function SignUpRoute() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react10.Center, {
    height: "100vh",
    p: 10,
...
var defaultProps2 = {
  isMobile: isMobile()
}, ManagerStateContext = import_react11.default.createContext(void 0);
...
function ManagerProvider({ children, manager }) {
  var _a;
  let [state, dispatch] = import_react11.default.useReducer(managerReducer, {
  ...
  return import_react11.default.createElement(ManagerStateContext.Provider, { value }, children);
}
function useManager() {
  let context = import_react11.default.useContext(ManagerStateContext);
  if (context === void 0)
...
var defaultProps3 = {
  ...
  slidingDelay: 200,
  initialSlide: 1
}, ControllerStateContext = import_react12.default.createContext(void 0);
...
function ControllerProvider({ children, controller }) {
  ...
  }, [state, dispatch] = import_react12.default.useReducer(settingsReducer, {
  ...
  }, [controller == null ? void 0 : controller.goToNextSlidePointer, goToNextSlide]), import_react12.default.useEffect(() => {
    controller != null && controller.goToPreviousSlidePointer && (controller.goToPreviousSlidePointer.current = goToPreviousSlide);
  }, [controller == null ? void 0 : controller.goToPreviousSlidePointer, goToNextSlide]), import_react12.default.useEffect(() => (dispatch({
  ...
  return import_react12.default.createElement(ControllerStateContext.Provider, { value }, children);
}
function useController() {
  let context = import_react12.default.useContext(ControllerStateContext);
  if (context === void 0)
...
var defaultProps4 = {
  ...
  thresholdToSlide: 50
}, AccessabilityStateContext = import_react13.default.createContext(void 0);
...
function AccessabilityProvider({ children, accessability }) {
  ...
  }, [state, dispatch] = import_react13.default.useReducer(accessabilityReducer, {
    initialX: void 0,
    initialY: void 0,
    currentX: void 0,
    currentY: void 0
  ...
  import_react13.default.useEffect(() => (window.addEventListener("keydown", onArrowKeypressHandler), () => {
  ...
  return import_react13.default.createElement(AccessabilityStateContext.Provider, { value }, children);
}
function useAccessability() {
  let context = import_react13.default.useContext(AccessabilityStateContext);
  if (context === void 0)
...
function ArrowSvg() {
  return import_react14.default.createElement(
    ...
    import_react14.default.createElement(
      "g",
      { fill: "currentColor" },
      import_react14.default.createElement("path", { d: "m40.4,121.3c-0.8,0.8-1.8,1.2-2.9,1.2s-2.1-0.4-2.9-1.2c-1.6-1.6-1.6-4.2 0-5.8l51-51-51-51c-1.6-1.6-1.6-4.2 0-5.8 1.6-1.6 4.2-1.6 5.8,0l53.9,53.9c1.6,1.6 1.6,4.2 0,5.8l-53.9,53.9z" })
    )
  );
}
function Buttons() {
    ...
    import_react14.default.createElement(
      ...
      import_react14.default.createElement(
        ...
        import_react14.default.createElement(
          ...
          import_react14.default.createElement(ArrowSvg, null)
        )
      )
    ),
    import_react14.default.createElement(
...
}, SettingsStateContext = import_react15.default.createContext(void 0);
function SettingsProvider({ children, settings }) {
  ...
  let value = params;
  return import_react15.default.createElement(SettingsStateContext.Provider, { value }, children);
}
function useSettings() {
  let context = import_react15.default.useContext(SettingsStateContext);
  if (context === void 0)
...
}, AnimationsStateContext = import_react16.default.createContext(void 0);
function AnimationsProvider({ children, animations }) {
  ...
  return import_react16.default.createElement(AnimationsStateContext.Provider, { value }, children);
}
function useAnimations() {
  let context = import_react16.default.useContext(AnimationsStateContext);
  if (context === void 0)
...
var import_react17 = __toESM(require("react")), mobileThreshold = 1024, LayoutStateContext = import_react17.default.createContext(void 0);
...
function LayoutProvider({ children }) {
  let [state, dispatch] = import_react17.default.useReducer(layoutReducer, {
    slider: import_react17.default.useRef(null),
    width: void 0,
    height: void 0
  });
  ...
  return import_react17.default.createElement(LayoutStateContext.Provider, { value }, children);
}
function useLayout() {
  let context = import_react17.default.useContext(LayoutStateContext);
  if (context === void 0)
...
var React2 = __toESM(require("react")), observerMap = /* @__PURE__ */ new Map(), RootIds = /* @__PURE__ */ new WeakMap(), rootId = 0, unsupportedValue;
...
function useInView({
  ...
  var _state$entry;
  let [ref, setRef] = React2.useState(null), callback = React2.useRef(), [state, setState] = React2.useState({
    inView: !!initialInView,
    entry: void 0
  });
  callback.current = onChange, React2.useEffect(
    () => {
      if (skip || !ref)
        return;
...
// node_modules/hero-slider/dist/modules/IntersectionObserver.js
var IntersectionObserverStateContext = import_react18.default.createContext(void 0);
function IntersectionObserverProvider({ children }) {
  let [ref, inView] = useInView({ threshold: 0 }), value = {
    elementObservedRef: ref,
    isInView: inView
  };
  return import_react18.default.createElement(IntersectionObserverStateContext.Provider, { value }, children);
}
function useIntersectionObserver() {
  let context = import_react18.default.useContext(IntersectionObserverStateContext);
  if (context === void 0)
...
}, AutoplayStateContext = import_react19.default.createContext(void 0);
...
function AutoplayProvider({ children, autoplay }) {
  ...
  }, [state, dispatch] = import_react19.default.useReducer(autoplayReducer, {
    isPausedByUser: !1,
  ...
  import_react19.default.useEffect(() => (state.isPausedByUser && clearTimeout(state.debounceTimeout), () => {
  }), [state.isPausedByUser]), import_react19.default.useEffect(() => {
    if (autoplay)
      switch (!0) {
  ...
  }, [autoplay, isInView]), import_react19.default.useEffect(() => () => {
    clearTimeout(state.debounceTimeout), autoplayInstance.stop();
  }, []), import_react19.default.useEffect(() => (clearTimeout(state.debounceTimeout), () => {
  ...
  return import_react19.default.createElement(AutoplayStateContext.Provider, { value }, children);
}
function useAutoplay() {
  let context = import_react19.default.useContext(AutoplayStateContext);
  if (context === void 0)
...
function Orchestrator({ className, width = "100%", height = "100vh", style, children }) {
  ...
  return import_react20.default.createElement(
    ...
    import_react20.default.createElement(
      ...
      children,
      shouldDisplayButtons && import_react20.default.createElement(Buttons, null)
    )
  );
}
            ...
            import_react20.default.createElement(
              ...
              import_react20.default.createElement(
                ...
                import_react20.default.createElement(
                  ...
                  import_react20.default.createElement(Orchestrator, { className: props.className, width: props.width, height: props.height, style: props.style }, props.children)
                )
              )
            )
          )
...
function AutoplayButton(props) {
  let { className, style, position = {
    bottom: "0",
    left: "0"
  } } = props, { state: { isPausedByUser }, autoplayState, resume, pause } = useAutoplay(), [buttonType, setButtonType] = import_react21.default.useState(autoplayState !== IntervalState.IDLE ? ButtonType.PAUSE : ButtonType.PLAY), onClickHandler = (event) => {
  ...
  return import_react21.default.useEffect(() => {
  ...
  }, [isPausedByUser, autoplayState]), import_react21.default.createElement(
    "button",
    ...
    import_react21.default.createElement(
      ...
      import_react21.default.createElement("path", { d: AutoplaySvg.getPath(buttonType) })
    )
  );
}
...
function Nav({ color, activeColor, position = {
  ...
  function renderButtons() {
    ...
    return Array.from(slides.values()).map(({ number }) => import_react22.default.createElement("li", { key: number, className: composeCssClasses("hero-slider-nav-button", NavModuleCss.Button, { className: NavModuleCss.Active, useIf: activeSlide === number }), onClick: () => onClickHandler(number) }));
  }
  let CSSVariables = {
    "--nav-color": color,
    "--nav-active-color": activeColor
  };
  return import_react22.default.createElement("ul", { className: composeCssClasses("hero-slider-nav-wrapper", NavModuleCss.Wrapper), style: Object.assign(Object.assign({}, position), CSSVariables) }, renderButtons());
}
...
function ButtonsNav(props) {
  ...
  if (Number(width) <= (componentMobileThreshold ?? mobileThreshold2))
    return isNullAfterThreshold ? null : import_react23.default.createElement(Nav, Object.assign({}, props));
  function renderButtons() {
    if (!totalSlides)
      return [];
    let onClickHandler = (slideNumber) => {
    ...
    return Array.from(slides.values()).map(({ number, label }) => {
      ...
      return import_react23.default.createElement(
        ...
        import_react23.default.createElement(
          ...
          import_react23.default.createElement("div", { className: composeCssClasses("hero-slider-buttons-nav-button-text", ButtonsNavModuleCss.Text) }, description)
        )
      );
    });
  }
  return import_react23.default.createElement(
    ...
    import_react23.default.createElement(
      ...
      renderButtons(),
      extraButton && import_react23.default.createElement("div", { className: composeCssClasses("hero-slider-buttons-nav-extra-button", ButtonsNavModuleCss.ExtraButton), style: {
...
function MenuNav(props) {
  ...
  if (Number(width) <= (componentMobileThreshold ?? mobileThreshold2))
    return isNullAfterThreshold ? null : import_react24.default.createElement(Nav, Object.assign({}, props));
  function renderButtons() {
    if (!totalSlides)
      return [];
    let onClickHandler = (slideNumber) => {
      ...
      return import_react24.default.createElement(
        ...
        import_react24.default.createElement(
          ...
          import_react24.default.createElement(
            ...
            number,
            import_react24.default.createElement("span", { className: composeCssClasses("hero-slider-menu-nav-button-square", MenuNavModuleCss.Square) })
          ),
          import_react24.default.createElement("div", { className: composeCssClasses("hero-slider-menu-nav-button-text", MenuNavModuleCss.Text) }, description)
        )
      );
    });
  }
  ...
  return import_react24.default.createElement(
    ...
    extraButton && import_react24.default.createElement(
      "div",
      { className: composeCssClasses("hero-slider-menu-nav-extra", MenuNavModuleCss.Extra), style: {
        order: isExtraButtonRight ? 1 : 0
      } },
      import_react24.default.createElement("span", { className: composeCssClasses("hero-slider-menu-nav-extra-button", MenuNavModuleCss.ExtraButton), style: {
    ...
    import_react24.default.createElement(
      ...
      renderButtons(),
      import_react24.default.createElement("span", { className: composeCssClasses("hero-slider-menu-nav-bar", MenuNavModuleCss.Bar), style: {
...
function Overlay(props) {
  return import_react25.default.createElement("div", { className: composeCssClasses("hero-slider-overlay", OverlayModuleCss.Container) }, props.children);
}
...
function SideNav({ color, activeColor, left, right, isPositionedRight = !0, position = {
  ...
  function renderButtons() {
    ...
    return Array.from(slides.values()).map(({ number }) => import_react26.default.createElement(
      "li",
      ...
      import_react26.default.createElement("span", { className: composeCssClasses("hero-slider-side-nav-button-line", SideNavModuleCss.Line) }),
      import_react26.default.createElement("span", { className: composeCssClasses("hero-slider-side-nav-button-number", SideNavModuleCss.Number) }, number.toLocaleString())
    ));
  }
  let CSSVariables = {
    "--nav-color": color,
  ...
  return import_react26.default.createElement("ul", { className: composeCssClasses("hero-slider-side-nav-wrapper", SideNavModuleCss.Wrapper), style: Object.assign(Object.assign({}, position), CSSVariables) }, renderButtons());
}
...
function Background(props) {
  let {
    ...
    shouldLazyLoad = !0,
    onLoad
  } = props, background = __rest(props, ["backgroundAnimation", "backgroundImageClassName", "backgroundImageBlendMode", "backgroundImageSizes", "backgroundImageSrcSet", "backgroundImageSrc", "backgroundImageAlt", "backgroundImageStyle", "maskBackgroundBlendMode", "shouldLazyLoad", "onLoad"]), [isLoaded, setIsLoaded] = import_react27.default.useState(!1), onLoadHandler = (event) => {
...
function Mask({ background, isActive }) {
  let { state: { isSliding } } = useController(), [className, setClassName] = import_react28.default.useState(MaskModuleCss.Loading), onLoadHandler = () => {
  ...
  return import_react28.default.createElement(
    ...
    import_react28.default.createElement("img", { alt: (background == null ? void 0 : background.backgroundImageAlt) || "", className: MaskModuleCss.Loader, onLoad: onLoadHandler, src: background == null ? void 0 : background.backgroundImageSrc, loading: background != null && background.shouldLazyLoad ? "lazy" : "eager" }),
    isLoaded && import_react28.default.createElement("div", { className: composeCssClasses("hero-slider-slide-mask-inner", className, MaskModuleCss.Inner, { className: MaskModuleCss.Sliding, useIf: isSliding }), style })
  );
}
...
function Slide(props) {
  ...
  }, [isActive, isSliding]), import_react29.default.useEffect(() => (slideRef && registerSlide(slideRef, label), () => {
  ...
  return import_react29.default.createElement(
    ...
    import_react29.default.createElement(Background, Object.assign({}, background, { onLoad: onBackgroundLoad })),
    import_react29.default.createElement(
      "div",
      { className: composeCssClasses("hero-slider-slide-wrapper", SlideModuleCss.Wrapper) },
      shouldRenderMask ? import_react29.default.createElement(Mask, { background, isActive }) : null,
      import_react29.default.createElement("div", { className: composeCssClasses("hero-slider-slide-container", SlideModuleCss.Container, { className: SlideModuleCss.Active, useIf: isActive && !isSliding }) }, children)
    )
  );
}
...
var import_styled = __toESM(require("@emotion/styled")), import_prop_types = __toESM(require("prop-types")), import_jsx_dev_runtime = require("react/jsx-dev-runtime"), WrapperDiv = import_styled.default.div({
  display: "flex",
...
var app = () => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(HeroSlider, {
  ...
  children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Overlay, {
      children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react30.Center, {
        h: "100%",
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react30.Stack, {
          alignItems: "center",
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_react30.Button, {
